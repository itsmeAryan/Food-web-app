...
const Login = () => {
    ...
    const AuthBtn=()=>{
        const obj={email,password:pass,user};
        SatrtAuth(Dis,obj)
    }
  return <div className="Auth">
      <div className="logger">
          ...
          <div className="items">
                    ...
                    <input type="text" onChange={(e)=>setuser(e.target.value)} value={user} placeholder="Enter Your Username" />
              </div>
              <div className="items">
              ...
              <div className="item-alreayd">
                  ...
                  <Link style={{color:"blue",fontSize:"17px"}} to="/login">Login</Link>
              </div>
              <div className="btns">
